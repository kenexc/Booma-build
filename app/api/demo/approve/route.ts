...
/*********
Purpose: Demo-only route to mark a refund as approved.
Assumptions: Allowed transition is initiated -> approved.
*********/
...
export async function POST(req: NextRequest) {
	...
	await update('refunds', { id: refund.id }, { status: 'approved' });
